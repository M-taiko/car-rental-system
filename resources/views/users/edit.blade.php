...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            ...
            <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('messages.edit_user') }}</span>
        </div>
    </div>
</div>
<!-- breadcrumb -->
                ...
                <div class="row row-sm mg-b-20">
                    <div class="col-lg-6">
                        ...
                        <select name="Status" id="select-beast" class="form-control nice-select custom-select">
                            <option value="{{ $user->Status }}">{{ $user->Status == 'active' ? __('messages.active') : __('messages.inactive') }}</option>
