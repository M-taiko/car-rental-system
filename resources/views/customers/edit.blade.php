...
@section('title')
    {{ __('messages.edit_customer') }} - {{ __('messages.CAR_RENTAL_SYSTEM') }}
@endsection
...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            ...
            <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('messages.edit_customer') }}</span>
        </div>
    </div>
</div>
@endsection
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <select class="form-control @error('id_type') is-invalid @enderror"
                                    ...
                                    <option value="national_id" {{ old('id_type', $customer->id_type) == 'national_id' ? 'selected' : '' }}>
                                        {{ __('messages.national_id') }}
                                    </option>
                                    <option value="iqama" {{ old('id_type', $customer->id_type) == 'iqama' ? 'selected' : '' }}>
                                        {{ __('messages.iqama') }}
                                    </option>
                                    <option value="passport" {{ old('id_type', $customer->id_type) == 'passport' ? 'selected' : '' }}>
