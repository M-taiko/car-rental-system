...
@section('title', __('messages.add_route'))
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ __('messages.add') }}</span>
            </div>
        </div>
    </div>
@endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">{{ __('messages.add_new_route') }}</h4>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('routes.store') }}" id="route-form" class="needs-validation" novalidate enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" step="0.01" min="0" 
                                           ...
                                           value="{{ old('distance_km') }}" required
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" step="0.01" min="0" 
                                           ...
                                           value="{{ old('external_cost', 0) }}" required
