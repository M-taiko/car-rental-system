                                ...
                                <div class="dropdown nav-item d-none d-md-flex">
                                    <a href="#" class="d-flex nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
                                        <span class="avatar country-Flag mr-0 align-self-center bg-transparent">
                                            <img src="{{ URL::asset('assets/img/flags/' . (app()->getLocale() === 'ar' ? 'saudi_flag.jpg' : 'us_flag.jpg')) }}" alt="flag">
                                        </span>
                                        <div class="my-auto">
                                            <strong class="mr-2 ml-2 my-auto">{{ app()->getLocale() === 'ar' ? 'العربية' : 'English' }}</strong>
                                        </div>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
                                        <a href="{{ route('language.switch', 'en') }}" class="dropdown-item d-flex">
                                            <span class="avatar ml-3 align-self-center bg-transparent">
                                                <img src="{{ URL::asset('assets/img/flags/us_flag.jpg') }}" alt="flag">
                                            </span>
                                            <div class="d-flex">
                                        ...
                                        <a href="{{ route('language.switch', 'ar') }}" class="dropdown-item d-flex">
                                            <span class="avatar ml-3 align-self-center bg-transparent">
                                                <img src="{{ URL::asset('assets/img/flags/saudi_flag.jpg') }}" alt="flag">
                                            </span>
                                            <div class="d-flex">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
                                    ...
                                    <form id="logout-form" action="{{ route('logout') }}" method="POST" >
                                        @csrf
                                        <button type="submit" class="dropdown-item" href="#"><i class="bx bx-log-out"></i> Sign Out</button>
                                    </form>
								</div>
							</div>
